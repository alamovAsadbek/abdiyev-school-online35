...
import { ArrowLeft, Clock, Eye, Calendar, FolderOpen, ClipboardList, Pencil, Trash2, CheckCircle2, XCircle, Search } from 'lucide-react';
                  ...
                  <tbody>
                    {filteredStats.length > 0 ? (
                      filteredStats.map((stat) => (
                        <tr key={stat.id} className="border-b border-border last:border-0 hover:bg-muted/30">
                          <td className="p-4">
                            <div>
