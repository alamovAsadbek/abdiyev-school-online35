    ...
    return (
        <DashboardLayout>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <div className="animate-fade-in cursor-pointer" style={{animationDelay: '0.1s'}}>
                    <StatCard
                        icon={FolderOpen}
                        label="Kurslar"
                ...
                <div className="animate-fade-in cursor-pointer" style={{animationDelay: '0.15s'}}>
                    <StatCard
                        icon={Video}
                        label="Video darslar"
                ...
                <div className="animate-fade-in cursor-pointer" style={{animationDelay: '0.2s'}}>
                    <StatCard
                        icon={ClipboardList}
                        label="Vazifalar"
                ...
                <div className="animate-fade-in cursor-pointer" style={{animationDelay: '0.25s'}}>
                    <StatCard
                        icon={Users}
                        label="O'quvchilar"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-8">
                ...
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h3 className="font-semibold text-card-foreground">Kurs qo'shish</h3>
                ...
                >
                    <div className="flex items-center gap-4">
                        <div
                            className="flex h-12 w-12 items-center justify-center rounded-xl bg-accent/10 text-accent group-hover:bg-accent group-hover:text-accent-foreground transition-colors">
                ...
                >
                    <div className="flex items-center gap-4">
                        <div
                            className="flex h-12 w-12 items-center justify-center rounded-xl bg-success/10 text-success group-hover:bg-success group-hover:text-success-foreground transition-colors">
                ...
                <Dialog open={isNotificationDialogOpen} onOpenChange={setIsNotificationDialogOpen}>
                    <DialogTrigger asChild>
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div
                                    className="flex h-12 w-12 items-center justify-center rounded-xl bg-warning/10 text-warning group-hover:bg-warning group-hover:text-warning-foreground transition-colors">
