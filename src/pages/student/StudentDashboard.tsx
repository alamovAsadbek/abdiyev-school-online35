    ...
    <DashboardLayout>
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => navigate('/student/categories')} className="text-sm text-primary hover:underline">Hammasini ko'rish</button>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {categories.map((category) => (
            <CategoryCard key={category.id} category={category} onClick={() => navigate(`/student/category/${category.id}`)} />
          ))}
        </div>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <button onClick={() => navigate('/student/videos')} className="text-sm text-primary hover:underline">Hammasini ko'rish</button>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {videos.map((video) => (
