                        ...
                        <TabsContent value="signup">
                            ...
                            <form onSubmit={handleSignup} className="space-y-4">
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-2">
                                        <Label htmlFor="signup-firstname">Ism <span
                                            className='text-destructive'>*</span></Label>
                                        <Input
                                            id="signup-firstname"
                                            type="text"
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="signup-lastname">Familiya <span
                                            className='text-destructive'>*</span></Label>
                                        <Input
                                            id="signup-lastname"
                                            type="text"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="signup-username">Foydalanuvchi nomi (username) <span
                                        className='text-destructive'>*</span></Label>
                                    <div className="relative">
                                        <User
                                            className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground"/>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="signup-password">Parol <span
                                        className='text-destructive'>*</span></Label>
                                    <div className="relative">
                                        <Lock
                                            className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground"/>
                                        ...
                                        <button
                                            ...
                                            className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground transition-colors"
                                        >
                                            {showSignupPassword ? <EyeOff className="h-5 w-5"/> :
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="signup-confirm-password">Parolni tasdiqlash <span
                                        className='text-destructive'>*</span></Label>
                                    <div className="relative">
                                        <Lock
                                            className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground"/>
