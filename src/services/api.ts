...
export const booksApi = {
    ...
    create: async (data: FormData) => {
        return api.post('/books/', data, true);
    },
    update: async (id: string, data: FormData) => {
        return api.put(`/books/${id}/`, data, true);
    },
    delete: async (id: string) => {
        return api.delete(`/books/${id}/`);
    },
    incrementDownload: async (id: string) => {
        return api.post(`/books/${id}/increment_download/`, {});
    },
    recordView: async (id: string) => {
        ...
        if (!token) {
            ...
            payload.device_id = guestId;
        }
        return api.post(`/books/${id}/record_view/`, payload);
    },
    getViewers: async (id: string) => {
        return api.get(`/books/${id}/viewers/`);
    },
    getGiftedUsers: async (id: string) => {
        return api.get(`/books/${id}/gifted_users/`);
    },
};

export const userBooksApi = {
    grantBook: async (bookId: string, userIds: string[], grantedBy: string = 'gift') => {
        return api.post('/user-books/grant_book/', {book_id: bookId, user_ids: userIds, granted_by: grantedBy});
    },
    revoke: async (userBookId: string) => {
        return api.post(`/user-books/${userBookId}/revoke/`, {});
    },
};
